...
def main() :
    ...
    ## 데이터 프레임으로 읽어서 화면에 표시!

    elif choice == menu[1] :
        upload_file = st.file_uploader('CSV파일들 선택', type=['csv'], accept_multiple_files=True) 
